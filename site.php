...
// $order->setdescomplement("Fundos"); // Teste do Complemento
$order->getdescomplement() != "" ? $complement = " - ".$order->getdescomplement()." - " : $complement = " - "; // Tratamento do complemento. Por Felipe Nascimento.
$dadosboleto["sacado"] = $order->getdesperson();
$dadosboleto["endereco1"] = $order->getdesaddress().$complement.$order->getdesdistrict();
...
// SEUS DADOS
$dadosboleto["identificacao"] = "Hcode Store";
