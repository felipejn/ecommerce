...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <p class="mb-0">
        <a href="register.html" class="text-center">Novo registro de usuário</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
...
<!-- jQuery -->
<script href="/res/admin/plugins/jquery/jquery.min.js"></script>
<!-- Bootstrap 4 -->
<script href="/res/admin/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
<!-- AdminLTE App -->
<script href="/res/admin/dist/js/adminlte.min.js"></script>
